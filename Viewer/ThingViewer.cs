...
namespace AcsViewer
{
    public partial class ThingViewer : Form
    {
        ...
        private void ShowActionParam()
        {
            ...
            {
                case SpellAction.ActionParameterType.Numeric:
                ...
                case SpellAction.ActionParameterType.Creature:
                    UIActionParam.Text = param.ToString() + " - " + Definition.CreatureList[param - 1].Name;
                    break;
        ...
        private void UIActionParam_DoubleClick(object sender, EventArgs e)
        {
            ...
            switch (this.Thing.Action.ParameterType)
            {
                case SpellAction.ActionParameterType.Message:
                    ...
                    form.Message = Definition.LongMessages[this.Thing.Action.Parameter - 1].CollapseSpace();
                    form.Title = "Long Message: " + this.Thing.Action.Parameter.ToString();
